...
<form method="POST" action="editConfiguration.php">
    ...
    Base expérience (Base * niveau = expérience demandée pour monter de niveau) : <input type="text" name="adminGameExperience" class="form-control" placeholder="Base expérience" value="<?php echo $adminGameExperience; ?>" required>
