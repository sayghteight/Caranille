...
<form method="POST" action="editConfiguration.php">
    ...
    Base expérience (base expérience * niveau actuel = expérience demandée pour monter de niveau) : <input type="number" name="adminGameExperience" class="form-control" placeholder="Base expérience" value="<?php echo $adminGameExperience; ?>" required>
