    ...
    && $_POST['adminOfferGold'] >= 0)
    {
        ...
        if ($adminCharacterId == 0)
        {
            ...
            while ($character = $characterQuery->fetch())
            {
                ...
                Vous venez d'offrir <em><?php echo $adminOfferGold ?></em> point(s) d'experience au joueur <em><?php echo $adminCharacterName ?></em><br />
        ...
        else
        {
            ...
            if ($characterRow == 1)
            {
                ...
                Vous venez d'offrir <em><?php echo $adminOfferGold ?></em> point(s) d'experience au joueur <em><?php echo $adminCharacterName ?></em>
