...
INSERT INTO `car_items` (`itemId`, `itemPicture`, `itemType`, `itemLevelRequired`, `itemName`, `itemDescription`, `itemHpEffect`, `itemMpEffect`, `itemStrengthEffect`, `itemMagicEffect`, `itemAgilityEffect`, `itemDefenseEffect`, `itemDefenseMagicEffect`, `itemWisdomEffect`, `itemPurchasePrice`, `itemSalePrice`) VALUES
(1, 'http://localhost/item.png', 'Item', 1, 'Potion', 'Cette petite fiole vous rendra 100 HP', 100, 0, 0, 0, 0, 0, 0, 0, 50, 10),
(2, 'http://localhost/item.png', 'Item', 1, 'Ether', 'Cette petite fiole vous rendra 10 MP', 0, 10, 0, 0, 0, 0, 0, 0, 50, 10),
(3, 'http://localhost/item.png', 'Armor', 1, 'Manteau de laine', 'Ce manteau vous ira a ravir.', 10, 1, 1, 1, 1, 1, 0, 1, 100, 50),
(4, 'http://localhost/item.png', 'Boots', 1, 'Botte de laine', 'Ses bottes de laine sont 100% moutons.', 10, 1, 1, 1, 1, 1, 0, 1, 100, 50),
(5, 'http://localhost/item.png', 'Gloves', 1, 'Gants de laine', 'Ses gants vous donneront vous protégerons des courants d''air mais juste pour les mains.', 10, 1, 1, 1, 1, 1, 0, 1, 100, 50),
(6, 'http://localhost/item.png', 'Helmet', 1, 'Casque de laine', 'Ce casque vous protégera juste de la pluie.', 10, 1, 1, 1, 1, 1, 0, 1, 100, 50),
(7, 'http://localhost/item.png', 'Weapon', 1, 'Boule de laine', 'Cette boule de laine pourra être lancée sur vos ennemis en leur occasionnant peu de dégâts.', 10, 1, 1, 1, 1, 1, 0, 1, 100, 50);
