...
CREATE TABLE IF NOT EXISTS `car_characters` (
  ...
  `characterArmorId` int(11) NOT NULL,
  `characterBootsId` int(11) NOT NULL,
  `characterGlovesId` int(11) NOT NULL,
  `characterHelmetId` int(11) NOT NULL,
  `characterWeaponId` int(11) NOT NULL,
